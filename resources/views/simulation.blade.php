        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                <form name="calculatorForm" ng-submit="simulation.calc(simulation.credit)" novalidate>
                    <div class="box-body">
                        <div class="form-group" ng-class="{ 'has-error' : calculatorForm.loanAmount.$invalid && !calculatorForm.loanAmount.$pristine }">
                            ...
                            <div class="input-group">
                                ...
                                <input ng-disabled="simulation.saving" ng-model="simulation.credit.loanAmount" required min="1000000" id="loan-amount" name="loanAmount" type="number" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    ...
                                    <select ng-disabled="simulation.saving" ng-model="simulation.credit.tenor" id="tenor" class="form-control">
                    ...
                    <div class="box-footer">
                        <button type="submit" ng-disabled="simulation.saving || calculatorForm.$invalid" class="btn btn-primary">Simulate</button>
                    </div>
                </form>
            </div><!-- /.box -->
            ...
            <div class="box box-warning">
                ...
                <form name="creditForm" ng-submit="simulation.save(simulation.credit)" novalidate>
                    <div class="box-body">
                        ...
                        <!-- text input -->
                        <div class="form-group" ng-class="{ 'has-error' : creditForm.fullName.$invalid && !creditForm.fullName.$pristine }">
                            ...
                            <input type="text" ng-disabled="simulation.saving || !simulation.simulated" class="form-control" ng-model="simulation.credit.fullName" id="full-name" name="fullName" required placeholder="Enter your full name..."/>
                        </div>
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group" ng-class="{ 'has-error' : creditForm.email.$invalid && !creditForm.email.$pristine }">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input ng-disabled="simulation.saving || !simulation.simulated" type="email" id="email" ng-model="simulation.credit.email" name="email" required class="form-control" placeholder="e.g name@domain.com" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group" class="form-group" ng-class="{ 'has-error' : creditForm.phone.$invalid && !creditForm.phone.$pristine }">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input ng-disabled="simulation.saving || !simulation.simulated" type="text" ng-model="simulation.credit.phone" name="phone" id="phone" required ng-pattern="/[0-9]{10,15}/" class="form-control" placeholder="e.g 081288489954" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box-footer">
                        <button type="submit" ng-disabled="simulation.saving || !simulation.simulated || creditForm.$invalid"  class="btn btn-success">{{ simulation.submitText  }}</button>
                    </div>
                </form>
            </div><!-- /.box -->
        </div><!--/.col (right) -->
