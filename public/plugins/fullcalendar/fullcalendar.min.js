...
(function (t) {
	...
	function d(e, n, i) {
		var r = Math.floor(n / e.length), s = Math.floor(n - r * (e.length - 1)), o = [], l = [], a = [], u = 0;
		c(e), e.each(function (n, i) {
			var d = n === e.length - 1 ? s : r, c = t(i).outerHeight(!0);
			...
			var i = e === o.length - 1 ? s : r, u = l[e], d = a[e], c = i - (u - d);
			i > u && t(n).height(c)
		})
	}
	...
	function q(t) {
		for (var e, n = [], i = /\[([^\]]*)\]|\(([^\)]*)\)|(LT|(\w)\4*o?)|([^\w\[\(]+)/g; e = i.exec(t);)e[1] ? n.push(e[1]) : e[2] ? n.push({maybe: q(e[2])}) : e[3] ? n.push({token: e[3]}) : e[5] && n.push(e[5]);
		return n
	}
	...
	function me(n, r) {
		...
		function a() {
			oe = te.theme ? "ui" : "fc", n.addClass("fc"), te.isRTL ? n.addClass("fc-rtl") : n.addClass("fc-ltr"), te.theme ? n.addClass("ui-widget") : n.addClass("fc-unthemed"), se = t("<div class='fc-view-container'/>").prependTo(n), ie = new ve(Q, te), re = ie.render(), re && n.prepend(re), c(te.defaultView), te.handleWindowResize && (ue = G(E, te.windowResizeDelay), t(window).resize(ue))
		}

		function u() {
			le && le.destroyView(), ie.destroy(), se.remove(), n.removeClass("fc fc-ltr fc-rtl fc-unthemed ui-widget"), t(window).unbind("resize", ue)
		}
		...
		function h(e, n) {
			pe++, le && n && le.type !== n && (ie.deactivateButton(le.type), j(), le.start && le.destroyView(), le.el.remove(), le = null), !le && n && (le = f(n), le.el = t("<div class='fc-view fc-" + n + "-view' />").appendTo(se), ie.activateButton(n)), le && (0 > e ? de = le.computePrevDate(de) : e > 0 && (de = le.computeNextDate(de)), le.start && !e && de.isWithin(le.intervalStart, le.intervalEnd) || d() && (j(), le.start && le.destroyView(), le.setDate(de), le.renderView(), X(), F(), z(), H())), X(), pe--
		}
		...
		function g(n) {
			...
			var r, s, l, a, u, d = te.defaultButtonText || {}, c = te.buttonText || {}, h = te.views || {}, f = n, g = [], p = !1;
			if (ge[n])return ge[n];
			for (; f && !s;)r = {}, i(Ce[f]), i(h[f]), g.unshift(r), f = r.type;
			return g.unshift({}), r = t.extend.apply(t, g), s ? (l = r.duration || s.duration, l && (l = e.duration(l), a = b(l), p = 1 === D(a, l)), p && h[a] && (r = t.extend({}, h[a], r)), u = c[n] || (p ? c[a] : null) || d[n] || (p ? d[a] : null) || r.buttonText || s.buttonText || (l ? o(l) : null) || n, ge[n] = {
				"class": s,
				options: r,
				buttonText: u
			}) : void 0
		...
		function L(t, e) {
			t = Q.moment(t), e = e ? Q.moment(e) : t.hasTime() ? t.clone().add(Q.defaultTimedEventDuration) : t.clone().add(Q.defaultAllDayEventDuration), le.select({
				start: t,
				end: e
			})
		}
		...
		function Z(t) {
			de.add(e.duration(t)), h()
		}

		function I(t, e) {
			var n, i;
			e && p(e) || (e = e || "day", n = ie.getViewsWithButtons().join(" "), i = n.match(RegExp("\\w+" + P(e))), i || (i = n.match(/\w+Day/)), e = i ? i[0] : "agendaDay"), de = t, c(e)
		}
		...
		r = r || {};
		var J, te = i({}, Ee, r);
		J = te.lang in Te ? Te[te.lang] : Te[Ee.lang], J && (te = i({}, Ee, J, r)), te.isRTL && (te = i({}, Ee, be, J || {}, r)), Q.options = te, Q.render = l, Q.destroy = u, Q.refetchEvents = S, Q.reportEvents = k, Q.reportEventChange = M, Q.rerenderEvents = C, Q.changeView = c, Q.select = L, Q.unselect = V, Q.prev = _, Q.next = A, Q.prevYear = N, Q.nextYear = Y, Q.today = O, Q.gotoDate = B, Q.incrementDate = Z, Q.zoomTo = I, Q.getDate = W, Q.getCalendar = $, Q.getView = U, Q.option = q, Q.trigger = K, Q.isValidViewType = p, Q.getViewButtonText = m;
		var ee = x(s(te.lang));
		...
		Q.defaultAllDayEventDuration = e.duration(te.defaultAllDayEventDuration), Q.defaultTimedEventDuration = e.duration(te.defaultTimedEventDuration), Q.moment = function () {
			var t;
			return "local" === te.timezone ? (t = De.moment.apply(null, arguments), t.hasTime() && t.local()) : t = "UTC" === te.timezone ? De.moment.utc.apply(null, arguments) : De.moment.parseZone.apply(null, arguments), "_locale"in t ? t._locale = ee : t._lang = ee, t
		...
		var ie, re, se, oe, le, ae, ue, de, ce = Q.isFetchNeeded, he = Q.fetchEvents, fe = n[0], ge = {}, pe = 0, me = [];
		de = null != te.defaultDate ? Q.moment(te.defaultDate) : Q.getNow(), Q.getSuggestedViewHeight = function () {
			return void 0 === ae && y(), ae
	...
	function ye(n) {
		...
		function s(e, n) {
			o(e, function (i) {
				...
				if (n == U) {
					if (i)for (r = 0; i.length > r; r++)s = i[r], o = l ? s : b(s, e), o && Q.push.apply(Q, H(o));
					q--, q || j(Q)
				}
			})
		}
		...
		function o(e, i) {
			...
			if (a)t.isFunction(a) ? (y(), a.call(O, B.clone(), Z.clone(), n.timezone, function (t) {
				...
				var u = e.url;
				if (u) {
					var d, c = e.success, h = e.error, f = e.complete;
					d = t.isFunction(e.data) ? e.data() : e.data;
					var g = t.extend({}, d || {}), p = F(e.startParam, n.startParam), m = F(e.endParam, n.endParam), v = F(e.timezoneParam, n.timezoneParam);
		...
		function R(e, n) {
			...
			return n = n || {}, n.start || (n.start = e.start.clone()), void 0 === n.end && (n.end = e.end ? e.end.clone() : null), null == n.allDay && (n.allDay = e.allDay), C(n), i = null !== e._end && null === n.end, r = n.allDay ? S(n.start, e._start) : E(n.start, e._start), !i && n.end && (s = E(n.end, n.start).subtract(E(e._end || O.getDefaultEventEnd(e._allDay, e._start), e._start))), t.each(n, function (t, e) {
				g(t) && void 0 !== e && (l[t] = e)
			}), o = z(v(e._id), i, n.allDay, r, s, l), {dateDelta: r, durationDelta: s, undo: o}
		}

		function z(e, n, i, r, s, o) {
			var l = O.getIsAmbigTimezone(), a = [];
		...
		function P(t, e) {
			var i = e.source || {}, r = F(e.constraint, i.constraint, n.eventConstraint), s = F(e.overlap, i.overlap, n.eventOverlap);
		...
		function G(t, e, n, i) {
			var r, s, o, l, a;
			if (t = {start: t.start.clone().stripZone(), end: t.end.clone().stripZone()}, null != e) {
		...
		function N(t, e) {
			var n = t.start.clone().stripZone(), i = O.getEventEnd(t).stripZone();
		...
		var B, Z, I = O.trigger, W = O.getView, j = O.reportEvents, X = {events: []}, $ = [X], U = 0, q = 0, K = 0, Q = [];
	...
	}, Se = {dayPopoverFormat: "dddd, MMMM D"}, be = {
	...
	}, De = t.fullCalendar = {version: "2.2.5"}, Ce = De.views = {};
	...
	var xe = {
		defaultButtonText: function (t) {
			return {prev: L(t.prevText), next: L(t.nextText), today: L(t.currentText)}
	...
	var Re, ke, Me, Fe = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], ze = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"], Le = {}.hasOwnProperty, Pe = /^\s*\d{4}-\d\d$/, Ve = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/, _e = e.fn, Ge = t.extend({}, _e);
	De.moment = function () {
		return A(arguments)
		...
		return null != t && (this._ambigTime = !1, this._ambigZone = !1), Ge.zone.apply(this, arguments)
	}, _e.local = function () {
	...
	var Oe = K.extend({
		...
		position: function () {
			var e, n, i, r, s, o = this.options, l = this.el.offsetParent().offset(), a = this.el.outerWidth(), u = this.el.outerHeight(), d = t(window), c = p(this.el);
		...
		getCell: function (t, e) {
			var n, i, r, s = this.rowCoords, o = this.colCoords, l = null, a = null;
		...
		computeRowCoords: function () {
			var t, e, n, i = [];
			for (t = 0; this.rowCnt > t; t++)e = this.getRowEl(t), n = {top: e.offset().top}, t > 0 && (i[t - 1].bottom = n.top), i.push(n);
			return n.bottom = n.top + e.outerHeight(), i
		},
		computeColCoords: function () {
			var t, e, n, i = [];
			for (t = 0; this.colCnt > t; t++)e = this.getColEl(t), n = {left: e.offset().left}, t > 0 && (i[t - 1].right = n.left), i.push(n);
		...
		dayMousedown: function (t) {
			var e, n, i = this, r = this.view, s = r.opt("selectable"), o = new Ie(this.coordMap, {
		...
		getDayClasses: function (t) {
			var e = this.view, n = e.calendar.getNow().stripTime(), i = ["fc-" + Fe[t.day()]];
	...
	Xe.mixin({
		mousedOverSeg: null, isDraggingSeg: !1, isResizingSeg: !1, segs: null, renderEvents: function (t) {
			...
			var n, i = this, r = this.view, s = t.el, o = t.event, l = new We(t.el, {
				parentEl: r.el,
				opacity: r.opt("dragOpacity"),
				revertDuration: r.opt("dragRevertDuration"),
				zIndex: 2
			}), d = new Ie(r.coordMap, {
				distance: 5, scroll: r.opt("dragScroll"), listenStart: function (t) {
					l.hide(), l.start(t)
			...
			var i, r, s, o, l, a = t.start, u = e.start;
			...
			var i, r, s = this, o = this.view, l = o.calendar, d = t.el, c = t.event, h = c.start, f = l.getEventEnd(c);
			r = new Ie(this.coordMap, {
				distance: 5, scroll: o.opt("dragScroll"), dragStart: function (e) {
					...
					}, c) ? (s.renderEventResize({start: h, end: i}, t), o.hideEvent(c)) : (i = null, a())
				}, cellOut: function () {
					i = null, n()
				}, dragStop: function (t) {
			...
			var e = this.view, n = t.source || {}, i = t.color, r = n.color, s = e.opt("eventColor"), o = t.backgroundColor || i || n.backgroundColor || r || e.opt("eventBackgroundColor") || s, l = t.borderColor || i || n.borderColor || r || e.opt("eventBorderColor") || s, a = t.textColor || n.textColor || e.opt("eventTextColor"), u = [];
	...
	var $e = Xe.extend({
		...
		computeCellRange: function (t) {
			var e = this.colCnt, n = t.row * e + (this.isRTL ? e - t.col - 1 : t.col), i = this.cellDates[n].clone(), r = i.clone().add(1, "day");
		...
		rangeToSegs: function (t) {
			var e, n, i, r, s, o, l, a, u, d, c = this.isRTL, h = this.rowCnt, f = this.colCnt, g = [];
	...
	$e.mixin({
		rowStructs: null, destroyEvents: function () {
			...
			var n, i = this.view, r = t.event, s = i.isEventDraggable(r), o = !e && r.allDay && t.isEnd && i.isEventResizable(r), l = this.getSegClasses(t, s, o), a = this.getEventSkinCss(r), u = "";
			...
			var r, s, o, l, a, u, d, c = this.colCnt, h = this.buildSegLevels(n), f = Math.max(1, h.length), g = t("<tbody/>"), p = [], m = [], v = [];
			for (r = 0; f > r; r++) {
		...
		segPopover: null, popoverSegs: null, destroySegPopover: function () {
			...
			var r, s, o, l, a, u, d, c, h, f, g, p, m, v, y, w, E = this, S = this.rowStructs[e], b = [], D = 0;
			...
			return t('<a class="fc-more"/>').text(this.getMoreLinkText(n.length)).on("click", function (s) {
				var o = r.opt("eventLimitClick"), l = e.start, a = t(this), u = i.getCellDayEl(e), d = i.getCellSegs(e), c = i.resliceDaySegs(d, l), h = i.resliceDaySegs(n, l);
			...
			var i, r = this.view, s = r.opt("theme"), o = e.start.format(r.opt("dayPopoverFormat")), l = t('<div class="fc-header ' + r.widgetHeaderClass + '">' + '<span class="fc-close ' + (s ? "ui-icon ui-icon-closethick" : "fc-icon fc-icon-x") + '"></span>' + '<span class="fc-title">' + z(o) + "</span>" + '<div class="fc-clear"/>' + "</div>" + '<div class="fc-body ' + r.widgetContentClass + '">' + '<div class="fc-event-container"></div>' + "</div>"), a = l.find(".fc-event-container");
	...
	var Ue = Xe.extend({
		...
		computeCellRange: function (t) {
			var e = this.computeSnapTime(t.row), n = this.view.calendar.rezoneDate(t.day).time(e), i = n.clone().add(this.snapDuration);
		...
		renderFill: function (e, n, i) {
			var r, s, o, l, a, u, d, c, h, f;
			if (n.length) {
				for (n = this.renderFillSegEls(e, n), r = this.groupSegCols(n), i = i || e.toLowerCase(), s = t('<div class="fc-' + i + '-skeleton">' + "<table><tr/></table>" + "</div>"), o = s.find("tr"), l = 0; r.length > l; l++)if (a = r[l], u = t("<td/>").appendTo(o), a.length)for (d = t('<div class="fc-' + i + '-container"/>').appendTo(u), c = this.colData[l].day, h = 0; a.length > h; h++)f = a[h], d.append(f.el.css({
	...
	var qe = De.View = K.extend({
		...
		computeRange: function (t) {
			var n, i, r = e.duration(this.opt("duration") || this.constructor.duration || {days: 1}), s = b(r), o = t.clone().startOf(s), l = o.clone().add(r);
		...
		computeScrollerHeight: function (t, e) {
			...
			return e = e || this.scrollerEl, n = this.el.add(e), n.css({
				position: "relative",
				left: -1
			}), i = this.el.outerHeight() - e.height(), n.css({position: "", left: ""}), t - i
		},
		...
		reportEventDrop: function (t, e, n, i) {
			var r = this.calendar, s = r.mutateEvent(t, e), o = function () {
		...
		reportEventResize: function (t, e, n, i) {
			var r = this.calendar, s = r.mutateEvent(t, {end: e}), o = function () {
				s.undo(), r.reportEventChange()
			};
	...
	var Ke = {dataType: "json", cache: !1}, Qe = 1, Je = Ce.basic = qe.extend({
		dayGrid: null,
		dayNumbersVisible: !1,
	...
	var tn = Ce.month = Je.extend({
		computeRange: function (t) {
			...
			return this.isFixedWeeks() && e.end.add(6 - e.end.diff(e.start, "weeks"), "weeks"), e
		}, setGridHeight: function (t, e) {
	...
	tn.duration = {months: 1}, Ce.basicWeek = {type: "basic", duration: {weeks: 1}}, Ce.basicDay = {
		type: "basic",
		duration: {days: 1}
	}, n({
		allDaySlot: !0,
	...
	}), Ce.agendaWeek = {type: "agenda", duration: {weeks: 1}}, Ce.agendaDay = {type: "agenda", duration: {days: 1}}
});