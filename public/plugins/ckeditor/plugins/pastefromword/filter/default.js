...
(function () {
	...
	var H = /^([.\d]*)+(em|ex|px|gd|rem|vw|vh|vm|ch|mm|cm|in|pt|pc|deg|rad|ms|s|hz|khz){1}?/i,
		...
		}, z = [[1E3, "M"], [900, "CM"], [500, "D"], [400, "CD"], [100, "C"], [90, "XC"], [50, "L"], [40, "XL"], [10, "X"], [9, "IX"], [5, "V"], [4, "IV"], [1, "I"]], B = "ABCDEFGHIJKLMNOPQRSTUVWXYZ", s = 0, t = null, w, E = CKEDITOR.plugins.pastefromword =
		{
			utils: {
				createListBulletMarker: function (a, c) {
					...
					if ((b = a.removeAnyChildWithName("cke:listbullet")) && b.length &&
						(b = b[0]))return a.name = "cke:li", c.style && (c.style = E.filters.stylesFilter([["text-indent"], ["line-height"], [/^margin(:?-left)?$/, null, function (a) {
						a = a.split(" ");
			...
			flattenList: function (a, c) {
				...
				for (n = 0; n < a.length; n++)if (j =
					...
					if (r) {
						for (h = 0; h < u; h++)g = q[h].attributes, g.style && (g.style = e([["list-style-type"]])(g.style) || "");
			...
			return {
				...
				elements: {
					...
					span: function (a) {
						...
						if (e = (b = a.attributes) && b.style)b.style = j([["line-height"],
