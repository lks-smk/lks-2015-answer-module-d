...
CKEDITOR.dialog.add("cellProperties", function (f) {
	var g = f.lang.table, c = g.cell, d = f.lang.common, h = CKEDITOR.dialog.validate, j = /^(\d+(?:\.\d+)?)(px|%)$/, e = {
		type: "html",
		html: "&nbsp;"
	}, k = "rtl" == f.lang.dir, i = f.plugins.colordialog;
	return {
		title: c.title,
				...
				type: "hbox", widths: ["40%", "5%", "40%"], children: [{
					...
					children: [{
						...
						e, {
							...
							label: c.vAlign,
							"default": "",
							items: [[d.notSet, ""], [d.alignTop, "top"], [d.alignMiddle, "middle"], [d.alignBottom,
								"bottom"], [c.alignBaseline, "baseline"]],
							setup: function (a) {
